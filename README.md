...
- **Projects/**
  - **sql-tasks-pharmacy-sales/**
    - **queries/**
      - `1_ТОП-3_аптеки.sql` — топ-3 аптеки по объёму продаж
      - `2_ТОП-3_лекарства.sql` — самые продаваемые лекарства
      - `3_Аптеки_с_оборотом_более_1_8_млн.sql` — аптеки с высоким оборотом
      ...
      - `6_ТОП-10_клиентов.sql` — самые ценные клиенты
      - `7_Кумулятивные_заказы_по_клиентам.sql` — customer lifetime в динамике
...
- `README.md` — описание проекта, задач и аналитических выводов
